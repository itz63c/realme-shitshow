...
public final class Handshake {
    ...
    public static Handshake get(SSLSession sSLSession) {
        ...
        if (cipherSuite2 == null) {
            throw new NetonException((Throwable) new IllegalStateException("cipherSuite == null"));
        }
        CipherSuite forJavaName = CipherSuite.forJavaName(cipherSuite2);
        String protocol = sSLSession.getProtocol();
        if (protocol == null) {
            throw new NetonException((Throwable) new IllegalStateException("tlsVersion == null"));
        }
        ...
        if (localCertificates2 != null) {
            emptyList2 = Util.immutableList((T[]) localCertificates2);
        } else {
    ...
    public static Handshake get(TlsVersion tlsVersion2, CipherSuite cipherSuite2, List<Certificate> list, List<Certificate> list2) {
        if (tlsVersion2 == null) {
            throw new NetonException((Throwable) new NullPointerException("tlsVersion == null"));
        } else if (cipherSuite2 != null) {
            return new Handshake(tlsVersion2, cipherSuite2, Util.immutableList(list), Util.immutableList(list2));
        } else {
            throw new NetonException((Throwable) new NullPointerException("cipherSuite == null"));
        }
    }
