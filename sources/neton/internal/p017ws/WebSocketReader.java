...
/* renamed from: neton.internal.ws.WebSocketReader */
final class WebSocketReader {
    ...
    /* renamed from: neton.internal.ws.WebSocketReader$FrameCallback */
    ...
    WebSocketReader(boolean z, BufferedSource bufferedSource, FrameCallback frameCallback2) {
        if (bufferedSource == null) {
            throw new NetonException((Throwable) new NullPointerException("source == null"));
        } else if (frameCallback2 == null) {
            throw new NetonException((Throwable) new NullPointerException("frameCallback == null"));
        } else {
            this.isClient = z;
    ...
    private void readHeader() {
        ...
        try {
            ...
            if (!this.isControlFrame || this.isFinalFrame) {
                ...
                if ((readByte & Constants.PROTOCOL_VERSION) != 0) {
                    z3 = true;
                } else {
                    z3 = false;
                }
