...
class Huffman {
    ...
    public void encode(okio.ByteString r9, okio.BufferedSink r10) {
        ...
        L_0x003e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: neton.internal.http2.Huffman.encode(okio.ByteString, okio.BufferedSink):void");
    }
