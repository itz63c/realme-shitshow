...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f830dn;
    private int end;
    private final int length = this.f830dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f830dn = x500Principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new NetonException((Throwable) new IllegalStateException("Unexpected end of DN: " + this.f830dn));
        }
        this.end = this.pos;
    ...
    private int getByte(int i) {
        ...
        int i3;
        if (i + 1 >= this.length) {
            throw new NetonException((Throwable) new IllegalStateException("Malformed DN: " + this.f830dn));
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    public final String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f830dn.toCharArray();
